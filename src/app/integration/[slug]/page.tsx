    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <nav className="mb-8">
        <ol className="flex items-center space-x-2 text-sm text-gray-500">
          ...
          <li>/</li>
          <li><Link href="/integration" className="hover:text-white transition">Integrations</Link></li>
          <li>/</li>
      ...
      <div className="mb-12">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-500">{integrationServers.length} compatible servers</p>
          </div>
        </div>
