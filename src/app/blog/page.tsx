...
export default function BlogPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Preview Articles */}
      <div className="mt-16">
        <h2 className="text-xl font-semibold text-gray-900 mb-6">Upcoming Articles</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="bg-white/50 border border-gray-200 rounded-lg p-4 flex items-center justify-between">
