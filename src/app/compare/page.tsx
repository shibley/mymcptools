        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {comparisons.slice(0, 12).map(comp => (
            <Link
              ...
              className="group bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-blue-500/50 transition"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {featured.map(server => (
            <Link
              ...
              className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-center hover:border-blue-500/50 transition"
            >
